...
class OtpRequestSignupView extends StatelessWidget {
  const OtpRequestSignupView({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocConsumer<OtpRequestSignupBloc, OtpRequestState>(
      ...
      builder: (context, state) {
        return OtpRequestView(
          ...
          onPrefixClick: () {},
          onActionClick: () {
            context.read<OtpRequestSignupBloc>().add(OnRequestOtpPressed());
          },
          actionText: 'next'.tr(),
        );
      },
